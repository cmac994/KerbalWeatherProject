...
namespace KerbalWeatherProject
{
    ...
    { 
        ...
        string bin_path = KSPUtil.ApplicationRootPath + "\\GameData\\KerbalWeatherproject\\Binary\\Climatology";

        const int NT = 6; //Number of Times (0-6 hr)
        const int NZ = 17; //Number of vertical levels (0-17)
        const int NLAT = 91; //latitude dim
        const int NLON = 181; //longitude dim
