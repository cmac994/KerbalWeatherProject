...
namespace KerbalWeatherProject_Lite
{
    ...
    public class weather_data : MonoBehaviour
    {
        ...
        public static Dictionary<string, int> get_dim_idx(double vheight, double epoch_time)
        {
        ...
        void Start()
        {
            ...
            point_3d = read_wx.getMPAS_3D(lsite);
            point_2d = read_wx.getMPAS_2D(lsite);
        ...
        public static void get_wxdata(string lsite)
        {
        ...
        public static double getAmbientPressure(double vheight)
        {
        ...
        //Retrieve ambient temperature at vessel location
        public static double getAmbientTemperature(double vheight)
        {
            double epoch_time = Util.getLocalTime_Wx(); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(vheight, epoch_time);  //Get index of coordinates closest to vessel location
            int t = idx["t"]; int z = idx["z"];
        ...
        //Retrieve ambient temperature at vessel location
        public static double get3DVar(double vheight, double ut, string vname)
        {
            double epoch_time = Util.getTime_Wx(ut); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(vheight, epoch_time);  //Get index of coordinates closest to vessel location
            int t = idx["t"]; int z = idx["z"];
        ...
        public static double get2DVar(double ut, string vname)
        {
            double epoch_time = Util.getTime_Wx(ut); //Get local time (i.e. UT time)
        ...
        public static wx_aero getPTD(double vheight)
        {
            double epoch_time = Util.getLocalTime_Wx(); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(vheight, epoch_time); //Get index of coordinates closest to vessel location
            int t = idx["t"]; int z = idx["z"];
        ...
        public static wx_wind getWind(double vheight)
        {
            double epoch_time = Util.getLocalTime_Wx(); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(vheight, epoch_time); //Get index of coordinates closest to vessel location
            int t = idx["t"]; int z = idx["z"];
        ...
        public static wx_atm getAmbientWx3D(double vheight)
        {
            double epoch_time = Util.getLocalTime_Wx(); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(vheight, epoch_time); //Get index of coordinates closest to vessel location
            int t = idx["t"]; int z = idx["z"];
        ...
        public static wx_srf getAmbientWx2D()
        {
            double epoch_time = Util.getLocalTime_Wx(); //Get local time (i.e. UT time)
            Dictionary<string, int> idx = get_dim_idx(0, epoch_time);  //Get index of coordinates closest to vessel location
            int t = idx["t"];
        ...
        public static wx_vel getVehicleVel(Vessel vessel, double vheight, bool wxenabled)
        {
        ...
        public static double linear_interp(int vidx, int tidx, double epoch_time)
        {
        ...
        public static double bilinear_interp(int vidx, int tidx, int hidx, double epoch_time, double radarAltitude)
        {
        ...
        public static double linear_interp3d(int vidx, int tidx, double epoch_time)
        {
