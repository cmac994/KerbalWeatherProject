...
namespace KerbalWeatherProject_Lite
{
    ...
    {
        private const string Message = "[KerbalWeatherProject_Lite]: Initiated";
        ...
        List<string> lsites = new List<string>() { "KSC", "DLS", "WLS"};
        ...
        List<double> lsites_lat = new List<double>() { -0.0972, -6.5603, 45.290 };
        List<double> lsites_lng = new List<double>() { -74.5571, -143.95, 136.1101};
